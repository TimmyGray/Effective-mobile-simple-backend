...
| B-C2 | Implement authorization schema and policy decision service for (user, resource, action) checks | backend | 2d | todo | Deny by default; central enforcement for all protected endpoints |
